...
## Directory Overview
- `docs/product` – product definition artifacts such as the MVP outline and UX flows.
- `docs/planning` – roadmap plus supporting backlog material.
  - `docs/planning/stories` – individual story maps for each MVP epic.
...
Each document now references other files by their relative paths (for example, the migration plan links to `../planning/ROADMAP.md`). Use this README as the entry point when navigating the repository.
...
- `docs/planning/ROADMAP.md` – sprint-by-sprint schedule.
- `docs/planning/stories/BitStockerz_MVP_0x_*.md` – story packs per epic (01–08).
...
### Lookup Tips
- When a document references another file, expect the relative paths listed above (e.g., migrations link to `../planning/ROADMAP.md`).
